...
├── demo_tests.py        # Testing framework demonstration
...
- **`pytest.ini`**: Pytest configuration file with test discovery, coverage settings, and custom markers.
- **`run_tests.py`**: Custom test runner script with options for different test types and coverage control.
- **`demo_tests.py`**: Demonstration script showcasing all testing framework capabilities.
- **`TESTING.md`**: Comprehensive documentation for the testing framework.
- **`tests/`**: Test directory containing all unit and integration tests with proper fixtures and mocking.
