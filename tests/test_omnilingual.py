...
try:
    ...
    audio_file = (
        "recordings/2025-11-16/call_20251116_160635_1001/chunk_0002_1763309224.mp3"
    )
    if os.path.exists(audio_file):
        ...
        if audio_duration:
            ...
            msg = (
                f"    ({rtf:.2f}x means it takes {rtf:.2f} seconds "
                "to process 1 second of audio)"
            )
            print(msg)
        ...
        msg = (
            f"[INFO] Test audio file not found at {audio_file}, "
