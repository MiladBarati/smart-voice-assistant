...
class TestElasticsearchLogger:
    ...
    def test_connect_success(self, mock_elasticsearch_client):
    ...
    def test_log_call_event(self, mock_elasticsearch_client):
    ...
    def test_health_check(self, mock_elasticsearch_client):
    ...
    def test_integration_with_real_elasticsearch(self):
