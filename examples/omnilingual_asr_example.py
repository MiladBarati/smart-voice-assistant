...
try:
    ...
    print("Warning: omnilingual-asr not available. Install with: uv add omnilingual-asr")
...
def transcribe_with_omnilingual(
    ...
    try:
        print(f"Loading omnilingual ASR model...")
...
def transcribe_call_recording(call_dir: str) -> None:
    ...
    Args:
        call_dir: Path to call directory (e.g., 'recordings/2025-11-15/call_20251115_120000_1001')
    """
    ...
    if incoming_files:
        ...
        for audio_file in incoming_files:
            ...
            if result:
                print(f"\nOriginal ({result.get('src_lang', 'unknown')}): {result.get('text', '')}")
                print(f"Translated to {result.get('tgt_lang', 'eng')}: {result.get('text', '')}")
...
if __name__ == "__main__":
    ...
    example_audio = "recordings/2025-11-02/call_20251102_180619_1001/20251102_180619_1001_incoming.wav"
