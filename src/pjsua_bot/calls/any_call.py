...
class AnyCall(GoodbyePlaybackMixin, RecordingCleanupMixin, pj.Call):
    ...
    def __init__(self, acc: pj.Account, call_id: int):
        ...
        self._recording_start_time: datetime | None = None  # Track when recording started
        ...
        self._outgoing_recording_start_time: datetime | None = None  # Track when outgoing recording started
        self._outgoing_recording_duration: float = 0.0  # Track outgoing recording duration in seconds
                ...
                try:
                    ...
                    if getattr(self._acc_ref, 'enable_recording', False):
                        ...
                        if self._recorder:
                            ...
                            if (
                                self._recording_file
                                and os.path.exists(self._recording_file)
                            ):
                                print(
                                ...
                                print(
                                    "***Recording: file not created yet (normal for PJSUA2)"
                                )
                        else:
                            print(
                                "***Recording: ERROR - AudioMediaRecorder creation failed"
                            )
                        ...
                        try:
                            ...
                            if getattr(self._acc_ref, 'enable_recording', False):
                                try:
                                    ...
                                    recorder.createRecorder(self._outgoing_recording_file, 0, 0)
                                    if self._player:
                                    ...
                                    print(
                                        "***Recording: started capturing outgoing audio to "
