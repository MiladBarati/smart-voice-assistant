...
FAQS: Dict[str, Dict[str, Any]] = {
    "slow_computer": {
        ...
        "response_audio": "assets/audio/faq_slow_computer_general.wav",  # Optional
        "priority": 1,
    },
    "computer_shuts_down": {
        "keywords": [
        ...
        "response_text": (
            ...
            "با واحد سخت افزار داخلی ۵۵۳۴ حوزه خاتون آباد و یا داخلی ۷۰۰۷ "
            "حوزه میدوک تماس بگیرید."
        ),
    ...
    "slow_internet": {
        ...
        "response_text": (
            ...
            "ریستارت کنید. سرعت اینترنت را تست کنید و با داخلی ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "forgot_login_password": {
        ...
        "response_text": (
            "از گزینه recovery استفاده کنید و یا برای ریست با داخلی ۷۴۰۰ یا "
            "۵۵۴۵ تماس بگیرید. برای آینده از manager password بهره ببرید."
        ),
    ...
    "forgot_chargooneh_password": {
        ...
        "response_text": (
            "به سامانه مجتمع مس شهربابک بروید. گزینه دریافت رمز عبور را بزنید سپس در "
            "گام بعدی کد ملی و شماره پرسنلی بزنید تا رمز موقت به موبایلتان بیاید."
        ),
    ...
    "forgot_inventory_password": {
        ...
        "response_text": ("با داخلی ۵۵۶۶ تماس بگیرید."),
    ...
    "user_account_locked": {
        ...
        "response_text": (
            "بعد از ۱۵ دقیقه خودبه‌خود باز می‌شود؛ در غیر این صورت تیکت بزنید و یا "
            "با داخلی ۵۵۴۵ و یا ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "system_off_domain": {
        ...
        "response_text": (
            "پس از ثبت تیکت، لطفاً با واحد نگهداری تجهیزات در حوزه خاتون آباد به "
            "داخلی ۵۵۳۴ و در حوزه میدوک به داخلی ۷۰۰۷ تماس بگیرید."
        ),
    ...
    "usb_port_blocked": {
        ...
        "response_text": (
            "سیاست سازمانی USB را بسته؛ تیکت بزنید تا واحد امنیت موضوع را بررسی کند."
        ),
    ...
    "windows_login_freeze": {
        ...
        "response_text": (
            "احتمال مشکل سخت افزاری وجود دارد با داخلی ۵۵۴۵ حوزه خاتون آباد و "
            "۷۰۰۷ حوزه میدوک تماس حاصل فرمایید."
        ),
    ...
    "slow_internet_general": {
        ...
        "response_text": (
            ...
            "روتر را ریستارت کنید. سرعت اینترنت را تست کنید و با داخلی ۷۴۰۰ تماس بگیرید."  # noqa: E501
        ),
    ...
    "company_network_issue": {
        ...
        "response_text": (
            "در حوزه خاتون آباد با داخلی های ۵۵۳۱ و ۵۵۳۲ و در حوزه میدوک با "
            "داخلی ۷۲۰۰ تماس بگیرید."
        ),
    ...
    "websites_not_loading": {
        ...
        "response_text": (
            "اینترنت خود را بررسی کنید. سپس با داخلی ۷۴۰۰ یا ۵۵۴۵ تماس بگیرید."
        ),
    ...
    "voip_not_working": {
        ...
        "response_text": (
            "تلفن را از پریز بکشید و دوباره بزنید؛ اگر مشکل حل نشد با شماره داخلی "
            "۵۵۱۱ حوزه خاتون آباد و داخلی ۷۰۴۰ حوزه میدوک تماس حاصل فرمایید."
        ),
    ...
    "request_peripheral_equipment": {
        ...
        "response_text": (
            "در سامانه تدارکات، درخواست تجهیزات را ثبت کنید (فرم ۹۵ در اتوماسیون چارگون). "  # noqa: E501
            "پس از تأیید مدیر، انبار حواله صادر می‌کند و تحویل تجهیزات به صورت حضوری انجام می‌شود."  # noqa: E501
        ),
    ...
    "usb_not_detected": {
        ...
        "response_text": (
            "پورت USB بسته می‌باشد. جهت دسترسی به پورت USB با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."  # noqa: E501
        ),
    ...
    "cannot_copy_from_flash": {
        ...
        "response_text": (
            "پورت USB بسته می‌باشد. با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."
        ),
    ...
    "blue_screen_general": {
        ...
        "response_text": (
            "کد خطا را یادداشت کنید و سیستم را Restart کنید. اگر مشکل سخت‌افزاری باشد، "
            "با داخلی ۵۵۳۴ حوزه خاتون آباد و ۷۰۰۷ میدوک تماس بگیرید."
        ),
    ...
    "virus_malware_infection": {
        ...
        "response_text": ("با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."),
    ...
    "antivirus_alerts": {
        ...
        "response_text": (
            "با همکاران نرم‌افزار حوزه خاتون آباد داخلی ۵۵۴۵ و حوزه میدوک داخلی ۷۴۰۰ تماس بگیرید."  # noqa: E501
        ),
    ...
    "display_issue": {
        ...
        "response_text": (
            "کابل‌ها را چک کنید و مانیتور را روی دستگاه دیگری تست کنید. اگر مشکل "
            "سخت‌افزاری بود با داخلی ۵۵۳۴ حوزه خاتون آباد و ۷۰۰۷ حوزه میدوک تماس بگیرید."
        ),
    ...
    "second_monitor_not_detected": {
        ...
        "response_text": ("کابل و پورت را چک کنید، رزولوشن را تنظیم کنید."),
    ...
    "chargooneh_attach_file": {
        ...
        "response_text": (
            ...
            "در صورت مشکل با داخلی ۷۸۲۱ تماس بگیرید."
        ),
    ...
    "chargooneh_increase_upload_limit": {
        ...
        "response_text": (
            "این تنظیمات با کارگزینی انجام می‌شود. با داخلی ۷۸۲۱ تماس بگیرید."
        ),
    ...
    "nextcloud_upload_issue": {
        ...
        "response_text": (
            "حجم فایل را چک کنید، کش مرورگر را پاک کنید و از مرورگر کروم/فایرفاکس به‌روز "  # noqa: E501
            "استفاده کنید. در صورت مشکل با داخلی ۵۵۴۵ و ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "nextcloud_how_to_use": {
        ...
        "response_text": (
            "به آدرس com.miduk.drive بروید، با نام کاربری و رمز دامین لاگین کنید، "
            "پوشه مورد نظر را انتخاب و فایل را در آنجا بارگزاری کنید. در صورت وجود هر "
            "نوع مشکل با داخلی ۵۵۴۵ یا ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "hard_drive_full": {
        ...
        "response_text": (
            "فایل‌های غیرضروری را حذف کنید، از فضای ابری استفاده کنید یا برای ارتقا با "
            "داخلی ۵۵۳۴ و ۷۰۰۷ تماس بگیرید."
        ),
    ...
    "external_hard_not_detected": {
        ...
        "response_text": (
            "پورت سیستم بسته می‌باشد. با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."
        ),
    ...
    "email_not_sending_or_receiving": {
        ...
        "response_text": (
            "لطفاً تنظیمات شبکه را بررسی کنید و در صورت ادامه مشکل، با داخلی ۵۵۰۰ تماس بگیرید."  # noqa: E501
        ),
    ...
    "emails_going_to_spam": {
        ...
        "response_text": (
            "تنظیمات filter spam را چک کنید، فرستنده را به List Safe اضافه کنید و "
            "با داخلی ۵۵۰۰ تماس بگیرید."
        ),
    ...
    "email_storage_full": {
        ...
        "response_text": (
            "لطفاً ایمیل‌های قدیمی و پیوست‌ها را حذف کنید یا تیکت ثبت نمایید تا واحد IT "
            "سقف ایمیل شما را به‌صورت موقت افزایش دهد. همچنین می‌توانید با داخلی ۵۵۵۰ "
            "(واحد سرچشمه) تماس بگیرید."
        ),
