...
FAQS: Dict[str, Dict[str, Any]] = {
    ...
    "slow_internet_general": {
        ...
        "response_text": (
            ...
            "روتر را ریستارت کنید. سرعت اینترنت را تست کنید و با داخلی ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "request_peripheral_equipment": {
        ...
        "response_text": (
            "در سامانه تدارکات، درخواست تجهیزات را ثبت کنید (فرم ۹۵ در اتوماسیون چارگون). "
            "پس از تأیید مدیر، انبار حواله صادر می‌کند و تحویل تجهیزات به صورت حضوری انجام می‌شود."
        ),
    ...
    "usb_not_detected": {
        ...
        "response_text": (
            "پورت USB بسته می‌باشد. جهت دسترسی به پورت USB با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."
        ),
    ...
    "virus_malware_infection": {
        ...
        "response_text": (
            "با واحد امنیت داخلی ۷۰۹۹ تماس بگیرید."
        ),
    ...
    "antivirus_alerts": {
        ...
        "response_text": (
            "با همکاران نرم‌افزار حوزه خاتون آباد داخلی ۵۵۴۵ و حوزه میدوک داخلی ۷۴۰۰ تماس بگیرید."
        ),
    ...
    "second_monitor_not_detected": {
        ...
        "response_text": (
            "کابل و پورت را چک کنید، رزولوشن را تنظیم کنید."
        ),
    ...
    "nextcloud_upload_issue": {
        ...
        "response_text": (
            "حجم فایل را چک کنید، کش مرورگر را پاک کنید و از مرورگر کروم/فایرفاکس به‌روز "
    ...
    "email_not_sending_or_receiving": {
        ...
        "response_text": (
            "لطفاً تنظیمات شبکه را بررسی کنید و در صورت ادامه مشکل، با داخلی ۵۵۰۰ تماس بگیرید."
        ),
